#pragma checksum "C:\src\goose2s\State\SpotifyStateProvider.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "af13e25834a1b784d98922ae66d7c6dbc1c13833"
// <auto-generated/>
...
#line 19 "C:\src\goose2s\State\SpotifyStateProvider.razor"
    ...
    {
        refreshTimer = new System.Threading.Timer(new System.Threading.TimerCallback(async _ => {
            if (CurrentContext != null && !CurrentContext.Failure) {
                var newToken = await AuthActions.RefreshToken(config, CurrentContext.refresh_token);
                CurrentContext.access_token = newToken.access_token;
                CurrentContext.expires_in = newToken.expires_in;
    ...
    public async Task SaveChangesAsync()
    {
        ...
        refreshTimer.Change((CurrentContext.expires_in-10)*1000, -1);
    }
